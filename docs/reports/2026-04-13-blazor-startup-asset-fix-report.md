...
- Post-fix `dotnet publish /home/runner/work/PoCompanion/PoCompanion/PoTool.Api/PoTool.Api.csproj -c Release -o /tmp/potool-api-publish --nologo` produced:
...
1. Built the solution before changes with `dotnet build /home/runner/work/PoCompanion/PoCompanion/PoTool.sln -c Release --nologo`.
2. Ran unit tests before changes with `dotnet test /home/runner/work/PoCompanion/PoCompanion/PoTool.Tests.Unit/PoTool.Tests.Unit.csproj -c Release --no-build --nologo` and confirmed there were pre-existing unrelated failures in governance/documentation audit tests.
...
5. Rebuilt successfully with `dotnet build /home/runner/work/PoCompanion/PoCompanion/PoTool.sln -c Release --nologo`.
