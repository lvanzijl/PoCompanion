...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase1-client-reachability-report.md` section 6.2
...
@* OBSOLETE (error:true): This entire page is UNUSED and should be deleted.
   ...
   See docs/reports/2026-03-30-cleanup-phase1-client-reachability-report.md section 3.1
*@
```
...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase1-client-reachability-report.md` section 3.1
...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase2-endpoint-usage-report.md` section 4.1
...
**Obsolete Marking:**
```csharp
[Obsolete("UNUSED: Only sent by obsolete TeamsController.DeleteTeam endpoint. UI uses ArchiveTeamCommand (soft delete) instead. See docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md section 3.2", error: true)]
```
...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md` section 3.2
...
**Obsolete Marking:**
```csharp
[Obsolete("UNUSED: Only handles obsolete DeleteTeamCommand. UI uses ArchiveTeamCommandHandler instead. See docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md section 3.3", error: true)]
```
...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md` section 3.3
...
**Obsolete Marking:**
```csharp
[Obsolete("UNUSED: Only called by obsolete DeleteTeamCommandHandler. UI uses ArchiveTeamAsync (soft delete) instead. See docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md section 3.4", error: true)]
...
**Report Reference:** `docs/reports/2026-03-30-cleanup-phase3-handler-usage-report.md` section 3.4
