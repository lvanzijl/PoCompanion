...
- `docs/architecture/cdc-reference.md` now explicitly states that effort-named fields can be legacy transport aliases for story points when they expose CDC-derived delivery, forecasting, or progress values
