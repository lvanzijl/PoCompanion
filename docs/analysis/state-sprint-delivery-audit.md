...
- **Canonical rule:** Delivery is attributed to a sprint only when the work item's first-ever canonical `Done` transition falls within that `SprintWindow`; sprint analytics about what happened during a sprint must come from updates, not current snapshots (`docs/architecture/domain-model.md:435-445`, `docs/rules/source-rules.md:21-37`).
...
- **Canonical rule:** `Committed scope = items whose IterationPath equals the sprint at CommitmentTimestamp`, where `CommitmentTimestamp = SprintStart + 1 day` (`docs/architecture/domain-model.md:427-431`, `docs/rules/sprint-rules.md:27-38`).
...
- **Canonical rule:** Delivery must be first-done-within-window, committed scope must be reconstructed at `SprintStart + 1 day`, and spillover means committed + not done at sprint end + moved to next sprint (`docs/architecture/domain-model.md:427-484`, `docs/rules/sprint-rules.md:27-96`).
...
- **Canonical rule:** Spillover requires committed scope, not done at sprint end, and moved to next sprint (`docs/architecture/domain-model.md:478-484`, `docs/rules/sprint-rules.md:90-96`).
...
- **File:** `docs/architecture/repository-domain-discovery.md`
...
- **Canonical rule:** Sprint delivery, churn, and spillover should follow the domain model in `docs/architecture/domain-model.md`.
...
- **File:** `docs/reports/2026-03-30-sprint-attribution-analysis.md`
