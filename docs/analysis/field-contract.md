...
- The domain rules in `docs/architecture/domain-model.md` and `docs/rules/estimation-rules.md` define Effort as an hours-based metric that may appear on `Epic`, `Feature`, and `PBI`.
