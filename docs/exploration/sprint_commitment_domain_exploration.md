...
3. **`docs/domain/REPOSITORY_DOMAIN_DISCOVERY.md` still describes older snapshot semantics**
...
| `docs/domain/REPOSITORY_DOMAIN_DISCOVERY.md` | Still describes `GetSprintMetricsQueryHandler` and projection logic with snapshot-oriented semantics. | Update repository discovery docs to match the current commitment/first-Done/spillover helpers. |
