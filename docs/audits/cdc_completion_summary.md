...
- Core Concepts
  - shared hierarchy, estimation, state, sprint, propagation, and source-truth semantics from `docs/domain/domain_model.md` and `docs/domain/rules/*.md`
- BacklogQuality
  - current-state backlog validation and readiness semantics documented in `docs/audits/backlog_quality_cdc_summary.md`
- SprintCommitment
  - commitment, scope change, completion, and spillover semantics documented in `docs/domain/sprint_commitment_domain_model.md`, `docs/domain/sprint_commitment_cdc_summary.md`, and `docs/audits/sprint_commitment_application_alignment.md`
- DeliveryTrends
  - historical delivery-trend semantics documented in `docs/audits/delivery_trend_analytics_cdc_summary.md`
- Forecasting
  - forecast, calibration, and completion projection semantics documented in `docs/domain/forecasting_domain_model.md` and `docs/audits/forecasting_cdc_summary.md`
- EffortDiagnostics
  - stable effort-diagnostics formulas documented in `docs/audits/effort_diagnostics_cdc_extraction_report.md`
- PortfolioFlow
  - story-point stock, inflow, throughput, and remaining scope semantics documented in `docs/domain/portfolio_flow_model.md`, `docs/audits/portfolio_flow_projection.md`, and `docs/audits/portfolio_flow_projection_validation.md`
- Shared Statistics
  - reusable pure-math contracts documented in `docs/audits/statistical_core_cleanup_report.md`
...
- SprintCommitment is the application-facing gateway for commitment, completion, and spillover reconstruction according to `docs/audits/sprint_commitment_application_alignment.md` and `docs/audits/cdc_coverage_audit.md`
...
- `docs/audits/application_semantic_audit.md` and `docs/audits/portfolio_flow_consumers_audit.md` document the remaining semantic mismatch at the application and presentation boundaries
...
- PortfolioFlow has canonical story-point projection materialization and projection validation documented in `docs/audits/portfolio_flow_projection.md` and `docs/audits/portfolio_flow_projection_validation.md`
