...
- `docs/architecture/cdc-reference.md` already assigns these outputs to `SprintCommitment`: `SprintCommitment`, `SprintScopeAdded`, `SprintScopeRemoved`, `SprintCompletion`, `SprintSpillover`, and derived story-point totals for commitment, added scope, removed scope, delivered scope, delivered-from-added scope, and spillover.
...
- improve consistency by making handlers consume the same canonical outputs already defined in `docs/architecture/cdc-reference.md`
