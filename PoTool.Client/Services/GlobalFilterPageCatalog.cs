...
public static class GlobalFilterPageCatalog
{
    ...
    private static bool TryGetPageDefinition(string route, out GlobalFilterPageDefinition definition)
    {
        definition = route switch
        {
            ...
            "planning/product-roadmaps" => new("ProductRoadmaps", true, true, false, false, FilterTimeMode.Snapshot),
            "planning/plan-board" => new("PlanBoard", true, true, false, true, FilterTimeMode.Snapshot),
            "bugs-triage" => new("BugsTriage", true, false, false, false, FilterTimeMode.Snapshot),
            "workitems" => new("WorkItemExplorer", true, false, false, false, FilterTimeMode.Snapshot),
            ...
            _ when route.StartsWith("planning/", StringComparison.Ordinal) && route.EndsWith("/product-roadmaps", StringComparison.Ordinal) => new("ProductRoadmaps", true, true, false, false, FilterTimeMode.Snapshot),
