...
public class PipelineSprintTrendsService
{
    ...
    /// <param name="productIds">Optional product IDs to filter pipeline definitions.</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var productParam = productIds != null
            ...
            : string.Empty;
        var url = $"api/Pipelines/sprint-trends?productOwnerId={productOwnerId}&{sprintParams}{productParam}";
