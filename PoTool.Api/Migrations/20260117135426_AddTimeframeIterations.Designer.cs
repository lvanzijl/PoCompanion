...
namespace PoTool.Api.Migrations
{
    ...
    [Migration("20260117135426_AddTimeframeIterations")]
    partial class AddTimeframeIterations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoTool.Api.Persistence.Entities.PullRequestEntity", b =>
                {
                    ...
                    b.Property<int?>("TimeframeIterationId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TimeframeIterationId");
            ...
            modelBuilder.Entity("PoTool.Api.Persistence.Entities.TimeframeIterationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("IterationKey")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("IterationKey")
                        .IsUnique();

                    b.HasIndex("Year", "WeekNumber")
                        .IsUnique();

                    b.ToTable("TimeframeIterations");
                });
            ...
            modelBuilder.Entity("PoTool.Api.Persistence.Entities.PullRequestEntity", b =>
                {
                    ...
                    b.HasOne("PoTool.Api.Persistence.Entities.TimeframeIterationEntity", "TimeframeIteration")
                        .WithMany()
                        .HasForeignKey("TimeframeIterationId");

                    b.Navigation("Product");

                    b.Navigation("TimeframeIteration");
                });
