...
public sealed class OnboardingMigrationExecutionServiceTests
{
    ...
    private static OnboardingMigrationExecutionService CreateService(PoToolDbContext context, FakeOnboardingLiveLookupClient lookupClient)
    {
    ...
    private sealed class FakeOnboardingLiveLookupClient : IOnboardingLiveLookupClient
    {
