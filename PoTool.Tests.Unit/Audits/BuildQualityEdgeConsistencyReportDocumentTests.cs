...
public sealed class BuildQualityEdgeConsistencyReportDocumentTests
{
    ...
    public void BuildQualityEdgeConsistencyReport_ReportExistsWithRequiredSectionsAndFindings()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "audits", "buildquality_edge_consistency_report.md");

        Assert.IsTrue(File.Exists(reportPath), "The BuildQuality edge consistency report should exist under docs/audits.");
