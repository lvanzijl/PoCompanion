...
public sealed class InsightValidationDocumentTests
{
    ...
    public void InsightValidation_ReportExistsWithRequiredSections()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "analysis", "insight-validation.md");

        Assert.IsTrue(File.Exists(reportPath), "The insight validation report should exist under docs/analysis.");
