...
public sealed class PortfolioFlowProjectionDocumentTests
{
    ...
    public void PortfolioFlowProjection_ReportExistsWithRequiredSectionsAndImplementationNotes()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "audits", "portfolio_flow_projection.md");

        Assert.IsTrue(File.Exists(reportPath), "The portfolio flow projection audit should exist under docs/audits.");
