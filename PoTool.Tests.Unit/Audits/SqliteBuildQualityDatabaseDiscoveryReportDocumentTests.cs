...
public sealed class SqliteBuildQualityDatabaseDiscoveryReportDocumentTests
{
    ...
    public void SqliteBuildQualityDatabaseDiscoveryReport_ReportExistsWithRequiredSectionsAndKeyFacts()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "audits", "sqlite_buildquality_database_discovery_report.md");

        Assert.IsTrue(File.Exists(reportPath), "The SQLite BuildQuality database discovery report should exist under docs/audits.");
