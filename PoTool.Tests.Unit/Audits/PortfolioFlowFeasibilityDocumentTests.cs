...
public sealed class PortfolioFlowFeasibilityDocumentTests
{
    ...
    public void PortfolioFlowFeasibility_ReportExistsWithRequiredSectionsAndKeyFindings()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "audits", "portfolio_flow_feasibility.md");

        Assert.IsTrue(File.Exists(reportPath), "The portfolio flow feasibility report should exist under docs/audits.");
