...
public sealed class ProjectionDeterminismAuditDocumentTests
{
    ...
    public void ProjectionDeterminismAudit_ReportExistsWithRequiredServicesChecksAndCoverage()
    {
        ...
        var reportPath = Path.Combine(repositoryRoot, "docs", "audits", "projection_determinism_audit.md");

        Assert.IsTrue(File.Exists(reportPath), "The projection determinism audit report should exist under docs/audits.");
